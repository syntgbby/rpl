        ...
        <div class="col-md-12">
            <div class="fv-row mb-8">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7">
                        <!--begin::Input-->
                        <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option" name="group_cd" id="group_cd">
                            <option ></option>
                            <?php foreach ($group as $row) : ?>
                                <option class="text-capitalize" value="<?= $row['group_cd'] ?>"><?= $row['group_cd'] ?></option>
                            <?php endforeach; ?>
                        </select>
                        <!--end::Input-->
                    </div>
